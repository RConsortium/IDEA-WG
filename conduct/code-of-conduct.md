...
We encourage the open exchange of ideas and expression and thus require an environment that recognizes the inherent worth of every person and group. An inclusive space free of harassment encourages interaction among diverse groups. `<EVENT>` is likely the first encounter of many people with this community; therefore, we want to make certain the experience is welcoming, and encourages them to be involved moving forward.
